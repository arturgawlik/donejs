...
class Response {
    ...
    text() {
        return new Promise((resolve, reject) => {
            ...
            // TODO: here only body should be return instead of whole raw response
            resolve(this.#rawWholeResponse);
        });
    }
    ...
    json() {
        return new Promise((resolve, reject) => {
            ...
            try {
                const json = JSON.parse(this.#rawWholeResponse);
                resolve(json);
            } catch (e) {
                reject(e);
            }
    ...
    #fetchResponse() {
        ...
        this.#rawWholeResponse = wholeResponse;
