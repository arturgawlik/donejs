...
${RUNTIME}: v8/include v8/libv8_monolith.a main.o ${RUNTIME}.o ## link the runtime for linux/macos
	@echo building ${RUNTIME} for ${os} on ${ARCH}
	$(LINK) $(LARGS) ${OPT} main.o ${RUNTIME}.o -o ${TARGET} -L"./v8" -lv8_monolith ${LIB_DIRS}
